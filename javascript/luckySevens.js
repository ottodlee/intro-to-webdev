...
function validateItems() {
    ...
    if (Number(startBet) < 1) {
     ...
     document.getElementById("results-totalSevens").innerText=sevensRolled;
     document.getElementById("results-totalRolls").innerText=totalRolls;
     document.getElementById("results-winPct").innerText=Math.round(sevensRolled/totalRolls*100*100)/100+"%";
